...
# load LOGO
logo_img = pygame.image.load('pictures\\azul_logo.png')
logo_img = pygame.transform.scale(logo_img, (int(0.48 * logo_img.get_width()), (0.44 * logo_img.get_height())))

# load legend
legend_img = pygame.image.load('pictures\\legend.png')
...
first_player_img = pygame.image.load('pictures\\first_player.png')
...
# load line images
square_img1 = pygame.image.load('pictures\square.png')
square_img2 = pygame.image.load('pictures\square2.png')
square_img3 = pygame.image.load('pictures\square3.png')
square_img4 = pygame.image.load('pictures\square4.png')
square_img5 = pygame.image.load('pictures\square5.png')
table_right_img = pygame.image.load('pictures\\table_right.png')
minus_points_img = pygame.image.load('pictures\minus_points.png')
...
square_img1_hover = pygame.image.load('pictures\square_hover.png')
square_img2_hover = pygame.image.load('pictures\square2_hover.png')
square_img3_hover = pygame.image.load('pictures\square3_hover.png')
square_img4_hover = pygame.image.load('pictures\square4_hover.png')
square_img5_hover = pygame.image.load('pictures\square5_hover.png')

# load player background image
player_background_img = pygame.image.load('pictures\player_background.png')
...
underlying_img = pygame.image.load('pictures\\underlying.png')
middle_underlying_img = pygame.image.load('pictures\\underlying_middle.png')

# load underlying hover images
underlying_img_hover = pygame.image.load('pictures\\underlying_hover.png')
middle_underlying_img_hover = pygame.image.load('pictures\\underlying_middle_hover.png')

# load stone images
blue_stone_img = pygame.image.load('pictures\stone_blue.png')        # VALUE 1
yellow_stone_img = pygame.image.load('pictures\stone_yellow.png')    # VALUE 2
black_stone_img = pygame.image.load('pictures\stone_black.png')      # VALUE 3
green_stone_img = pygame.image.load('pictures\stone_green.png')      # VALUE 4
red_stone_img = pygame.image.load('pictures\stone_red.png')          # VALUE 5
stone_minus_img = pygame.image.load('pictures\stone_minus.png')      # VALUE -1
...
def new_round_init(font, screen, SCREEN_WIDTH):    
...
def draw_bg_lines_info_stones_left(screen, font):
    # handle drawing of tables
    # draw background
    draw_player_backgrounds(NUM_PLAYERS, screen)
    # drawing lines
    ...
    # draw player info
    draw_player_info(NUM_PLAYERS, screen, font)
...
def draw_points_right_end_round(font, screen, SCREEN_WIDTH):
    for table in bv.list_of_tables:
        for line in table:    
            if line.name == 'table right':
                if bv.empty:
...
def draw_underlyings_and_stones(font, screen, SCREEN_WIDTH):
